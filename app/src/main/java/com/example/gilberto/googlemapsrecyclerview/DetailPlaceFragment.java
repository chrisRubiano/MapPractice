...
public class DetailPlaceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView placeNameText = (TextView) v.findViewById(R.id.place_name_attribute);
        TextView placeRankingText = (TextView) v.findViewById(R.id.place_ranking_attribute);
        ...
        Picasso.with(getActivity()).load(mPlace.getImage_url()).into(placeImageView);
        placeNameText.setText(mPlace.getName());
        placeRankingText.setText(String.valueOf(mPlace.getRanking()));
